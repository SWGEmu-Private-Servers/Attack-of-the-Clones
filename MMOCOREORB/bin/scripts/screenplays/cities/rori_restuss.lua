...
function RoriRestussScreenPlay:spawnSceneObjects()
	...
	--spawnSceneObject("rori", "object/installation/faction_perk/covert_detector/detector_base.iff", 5376.78, 80, 5666.8, 0, math.rad(179) )
end
...
function RoriRestussScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "restuss_magnaguard", 300, 5117.84, 80, 5663.18, 5, 0)
	...
	--Disabling mobs temporarily until the destroyed building asset is removed, can be rearranged as needed
	...
	spawnMobile("rori", "restuss_padawan", 300, 5330.18, 80, 5541.35, 182, 0)
	spawnMobile("rori", "restuss_padawan", 300, 5285.23, 80, 5538.02, 343, 0)
	spawnMobile("rori", "restuss_magnaguard", 300, 5285.46, 80, 5542.79, 190, 0)
	...
	--Vendor
	spawnMobile("rori", "restussmerch_rep", 300, 5374.48, 80, 5665.8, 178, 0)
