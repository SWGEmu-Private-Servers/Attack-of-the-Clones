...
veteranRewards = {
		...
		{templateFile = "object/tangible/veteran_reward/one_year_anniversary/painting_02.iff", milestone=460, oneTime=false, description="Painting: Armored Assault Tank"},
		...
		{templateFile = "object/tangible/veteran_reward/one_year_anniversary/painting_08.iff", milestone=460, oneTime=false, description="Painting: Droid Control Ship"},
		{templateFile = "object/tangible/veteran_reward/one_year_anniversary/painting_09.iff", milestone=460, oneTime=false, description="Painting: Lightsaber Cutaway"},
