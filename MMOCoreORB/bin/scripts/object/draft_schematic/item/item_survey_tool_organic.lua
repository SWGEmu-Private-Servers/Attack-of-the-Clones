...
object_draft_schematic_item_item_survey_tool_organic = object_draft_schematic_item_shared_item_survey_tool_organic:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Organic Survey Device",
...
ObjectTemplates:addTemplate(object_draft_schematic_item_item_survey_tool_organic, "object/draft_schematic/item/item_survey_tool_organic.iff")
