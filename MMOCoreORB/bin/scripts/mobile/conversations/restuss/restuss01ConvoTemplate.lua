restuss01ConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
	luaClassHandler = "restuss01ConvoHandler",
	screens = {}
}
...
restuss01ConvoTemplate:addScreen(quest);
...
restuss01ConvoTemplate:addScreen(information_one);
...
restuss01ConvoTemplate:addScreen(information_two);
...
restuss01ConvoTemplate:addScreen(complete_quest);
...
restuss01ConvoTemplate:addScreen(decline);
...
restuss01ConvoTemplate:addScreen(quest_reject);
...
restuss01ConvoTemplate:addScreen(quest_completed);

addConversationTemplate("restuss01ConvoTemplate", restuss01ConvoTemplate);
