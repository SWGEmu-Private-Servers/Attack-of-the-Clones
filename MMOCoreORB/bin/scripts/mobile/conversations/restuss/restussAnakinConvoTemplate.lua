restussAnakinConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
	luaClassHandler = "restussAnakinConvoHandler",
	screens = {}
}
...
restussAnakinConvoTemplate:addScreen(init);
...
restussAnakinConvoTemplate:addScreen(information_one);
...
restussAnakinConvoTemplate:addScreen(information_two);
...
restussAnakinConvoTemplate:addScreen(information_three);
...
restussAnakinConvoTemplate:addScreen(start_quest);
...
restussAnakinConvoTemplate:addScreen(return_quest);
...
restussAnakinConvoTemplate:addScreen(quest_in_progress);
...
restussAnakinConvoTemplate:addScreen(quest_completed);
...
restussAnakinConvoTemplate:addScreen(complete_quest);
...
restussAnakinConvoTemplate:addScreen(decline);

traitor = ConvoScreen:new {
	id = "traitor",
	customDialogText = "Separatist Scum!",
	stopConversation = "true",
	options = {
	}
}
restussAnakinConvoTemplate:addScreen(traitor);

addConversationTemplate("restussAnakinConvoTemplate", restussAnakinConvoTemplate);
